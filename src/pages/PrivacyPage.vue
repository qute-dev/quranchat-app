<template>
  <q-page class="column">
    <!-- TOP HEADER  -->
    <page-header title="QuranChat.me" subtitle="User privacy policy" />
    ...
    <div class="q-mx-md">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Company downloaded by You on any electronic device, named QuranChat.me
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to QuranChat.me.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: admin@quranchat.me</li>
      </ul>
    </div>
  </q-page>
</template>
